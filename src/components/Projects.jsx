...
const ProjectCard = ({ project }) => (
  <div className="bg-white dark:bg-gray-800/30 shadow-lg dark:shadow-none rounded-xl p-6 flex flex-col gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
    {/* Project Image */}
